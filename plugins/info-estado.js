...
handler.help = ['estado'];
handler.tags = ['main'];
handler.command = /^(servicio|Servicio|Servicios|servicios|SERVICIOS|Comprar|comprar|COMPRAR)$/i;
